...
#define LV_MEM_CUSTOM 1
    ...
    /*Instead of an address give a memory allocator that will be called to get a memory pool for LVGL. E.g. my_malloc*/
        ...
        #define LV_MEM_POOL_ALLOC(size)  heap_caps_malloc(size, MALLOC_CAP_SPIRAM)          /* Uncomment if using an external allocator*/
    #endif
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(fira) LV_FONT_DECLARE(digital)  LV_FONT_DECLARE(fira24) 

/*Always set a default font*/
#define LV_FONT_DEFAULT &fira
