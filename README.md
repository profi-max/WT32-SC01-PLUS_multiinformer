...
![Файловый менеджер](/Pictures/web_file_mgr.png)
...
Для получения данных о погоде вам предварительно нужно получить API ключ с сайта Open Weather Maps [по этой инструкции](https://projectalt.ru/load/proekty_na_arduino_i_esp8266/esp8266/prostaja_meteostancija_na_esp8266/12-1-0-37#id-2).
