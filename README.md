...
Это вариант исходного проекта [multiinformer](https://github.com/altJSV/multiinformer), автор исходного проекта [altJSV](https://github.com/altJSV) - спасибо автору. Этот репозиторий содержит проект в папке **Project** для компиляции в среде VSCode + Platformio. Готовая прошивка с видеоинструкцией находится в папке **Firmware**.
